...
//Dataları yönetirken durum yönetimine dikkat etmek gerekir
cart.map(product=>{console.log(product.productName+" : "+product.unitPrice*product.quantity)})

//acc:toplam aslında başlangıç degeri 0 dedik. product her bir ürünü dolaşacak
let total=cart.reduce((acc,product)=>acc+product.unitPrice*product.quantity,0)
console.log(total)

//filter yedek bir array e atıyor
